...
build:
	...
	@make --no-print-directory -f $(mkfile_path)/ips/register_interface.mk build
	@make --no-print-directory -f $(mkfile_path)/ips/pulp_soc.mk build
	@make --no-print-directory -f $(mkfile_path)/ips/tbtools.mk build
	@make --no-print-directory -f $(mkfile_path)/ips/my_core.mk build
...
lib:
	...
	@make --no-print-directory -f $(mkfile_path)/ips/register_interface.mk lib
	@make --no-print-directory -f $(mkfile_path)/ips/pulp_soc.mk lib
	@make --no-print-directory -f $(mkfile_path)/ips/tbtools.mk lib
	@make --no-print-directory -f $(mkfile_path)/ips/my_core.mk lib
...
clean:
	...
	@make --no-print-directory -f $(mkfile_path)/ips/register_interface.mk clean
	@make --no-print-directory -f $(mkfile_path)/ips/pulp_soc.mk clean
	@make --no-print-directory -f $(mkfile_path)/ips/tbtools.mk clean
	@make --no-print-directory -f $(mkfile_path)/ips/my_core.mk clean
